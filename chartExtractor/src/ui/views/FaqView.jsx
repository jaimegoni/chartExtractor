...
export const FaqView = ()=>{
    ...
    return(
        <StandardView>
            <>
                <h1 >Do we keep any data from you or your images?</h1>
                <hr/>
                ...
                <h1 >Why aren't my images stored anymore?</h1>
                <hr/>
                ...
                <h1 >I'm working in Chrome and my images are not displayed in Firefox (or vice-versa). Why can't I see my images in different browsers?</h1>
                <hr/>
                ...
                <h1 >Is this an open source project?</h1>
                <hr/>
