    ...
    return(
        <StandardView>
            <>
                ...
                <h1 style={{fontSize:"2em"}}>Why aren't my images stored anymore?</h1>
                <hr/>
                ...
                <h1 style={{fontSize:"2em"}}>I'm working in Chrome and my images are not displayed in Firefox (or vice-versa). Why can't I see my images in different browsers?</h1>
                <hr/>
